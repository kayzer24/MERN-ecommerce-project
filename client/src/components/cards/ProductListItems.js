...
const ProductListItems = ({product}) => {
    ...
    return (
        <ul className="list-group">
            ...
            {subs && (
                <li className="list-group-item">Sub Categories{" "}
                    {subs.map((sub) =>
                        <Link key={sub._id} to={`/sub/${sub.slug}`} className="label label-default label-pill pull-xs-right">
                            {sub.name}
                        </Link>
                    )}
                </li>)
            ...
            <li className="list-group-item">Sold{" "}
                <span className="label label-default label-pill pull-xs-right">
                    {sold}
                </span>
            </li>
